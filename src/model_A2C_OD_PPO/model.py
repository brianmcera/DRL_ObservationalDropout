...
class Model(Model):
    def __init__(self, ac_dim):
        ...
        self.conv1 = Conv2D(16, 3, kernel_regularizer=regularizers.l2(0.001))
        self.conv2 = Conv2D(32, 3, kernel_regularizer=regularizers.l2(0.001))
        self.conv3 = Conv2D(32, 3, kernel_regularizer=regularizers.l2(0.001))
