...
class Model(Model):
    def __init__(self, ac_dim):
        ...
        self.conv1 = Conv2D(4, 5, activation='relu', kernel_regularizer=tf.keras.regularizers.l2(1e-4))
        self.conv2 = Conv2D(4, 5, activation='relu', kernel_regularizer=tf.keras.regularizers.l2(1e-4))
        self.conv3 = Conv2D(8, 5, activation='relu', kernel_regularizer=tf.keras.regularizers.l2(1e-4))
