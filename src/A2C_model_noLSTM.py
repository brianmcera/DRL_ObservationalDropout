...
class Model(Model):
    def __init__(self, ac_dim):
        ...
        self.conv1 = Conv2D(64, 3, kernel_regularizer=regularizers.l2(0.01))
        self.conv2 = Conv2D(128, 3, kernel_regularizer=regularizers.l2(0.01))
        self.conv3 = Conv2D(128, 3, kernel_regularizer=regularizers.l2(0.01))
        ...
        self.d1 = Dense(256, activation='relu', kernel_regularizer=regularizers.l2(0.01))
        self.d2 = Dense(100, activation='relu', kernel_regularizer=regularizers.l2(0.01))
        self.d3 = Dense(100, activation='relu', kernel_regularizer=regularizers.l2(0.01))
        self.d4 = Dense(256, activation='relu', kernel_regularizer=regularizers.l2(0.01))
        self.d5 = Dense(100, activation='relu', kernel_regularizer=regularizers.l2(0.01))
        self.d6 = Dense(100, activation='relu', kernel_regularizer=regularizers.l2(0.01))
