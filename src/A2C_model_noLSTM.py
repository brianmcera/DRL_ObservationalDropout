...
class Model(Model):
    def __init__(self, ac_dim):
        ...
        self.conv1 = Conv2D(32, 3, activation='relu', kernel_regularizer=tf.keras.regularizers.l2(1e-2))
        self.conv2 = Conv2D(64, 3, activation='relu', kernel_regularizer=tf.keras.regularizers.l2(1e-2))
        self.conv3 = Conv2D(64, 3, activation='relu', kernel_regularizer=tf.keras.regularizers.l2(1e-2))
        self.maxpool1 = MaxPool2D(pool_size=(2,2))
        self.maxpool2 = MaxPool2D(pool_size=(2,2))
        self.maxpool3 = MaxPool2D(pool_size=(2,2))
        self.flatten = Flatten()
        self.d1 = Dense(256, activation='relu', kernel_regularizer=tf.keras.regularizers.l2(1e-2))
        self.d2 = Dense(20, activation='relu', kernel_regularizer=tf.keras.regularizers.l2(1e-2))
        self.d3 = Dense(20, activation='relu', kernel_regularizer=tf.keras.regularizers.l2(1e-2))
        self.d4 = Dense(256, activation='relu', kernel_regularizer=tf.keras.regularizers.l2(1e-2))
        self.d5 = Dense(20, activation='relu', kernel_regularizer=tf.keras.regularizers.l2(1e-2))
        self.d6 = Dense(20, activation='relu', kernel_regularizer=tf.keras.regularizers.l2(1e-2))
